...
import { Settings, User, Bell, Lock, Shield, Languages as Language, Moon, Sun, Stethoscope } from 'lucide-react';
      ...
      <div className="grid gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-medical-blue-500 focus:border-medical-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                  defaultValue="dr.smith@clinique.com"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Durée de consultation par défaut
                </label>
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-medical-blue-500 focus:border-medical-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Délai minimum de prise de rendez-vous
                </label>
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-medical-blue-500 focus:border-medical-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Téléconsultations</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Activer les consultations vidéo
                </p>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Rappels de consultation</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Recevoir un rappel avant chaque consultation
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" defaultChecked />
